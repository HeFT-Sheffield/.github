...
### CHAPSim2
[CHAPSim2](https://github.com/CCP-NTH/CHAPSim2) is a direct numerical solver for thermal-hydraulics with strong thermophysical property variations and magnetohydrodynamics. The [2decomp&FFT](https://github.com/2decomp-fft/2decomp-fft) is used for domain decomposition and fast Fourier transforms. CHAPSim2 is highly scalable, tested on 32,000 cores on Archer2.
